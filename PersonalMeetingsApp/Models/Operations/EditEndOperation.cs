...
{
    internal struct EditEndOperation : IOperation
    {
        ...
        public string InstructionMessage => Messages.EnterNewEndTime;
        public string SuccessMessage => Messages.EditMeetingSuccess;

        public EditEndOperation(ref List<IMeeting> meetings)
        {
            _meetings = meetings;
        }
        ...
        public void Parse(string s)
        {
            ...
            if (dataArr.Length == 3)   //date, endTime, meetId
            {
        ...
        public void Run()
        {
            ...
            if (!editedMeeting.TryEditEndTime(dateTime))
            {
